...
public class ReminderModel {
	...
	private int hour;
	private int minute;
	private int repeatIntervalTime = 5;
	...
	public void startReminder(String time1, String time2, String time3, String time4){
		//this.time = time;
		...
		if(cal2.YEAR == 2017){
		 ...
		 if(time1.length() == 5){
        	 ...
        	 minute = Integer.parseInt(time1.substring(3,4));
