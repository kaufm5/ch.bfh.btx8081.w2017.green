...
public class DiaryEntry implements Serializable {
	...
	/**
	 * <p>
	 * An Entry consists of a Diary Entry Number : serial a Title :
	 * <code>String</code><br>
	 * a Text : <code>String</code> a Tag : <code>String</code> and a Parameter of
	 * the actual Mood : Mood (Enumeration)
	 * </p>
	 */
